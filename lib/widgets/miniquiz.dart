      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ...List.generate((currentQuestion["opciones"] as List).length, (index) {
...
class QuizProvider extends ChangeNotifier {
  ...
  final List<Map<String, dynamic>> preguntas = [
    {
      ...
      "opciones": ["Estaba descansando", "Estaba cosechando", "Estaba arando el campo", "Estaba vendiendo frutas"],
      "respuesta": "Estaba arando el campo",
    },
    {
      "pregunta": "¿Qué sucedió cuando las monedas cayeron dentro del cazo?",
      "opciones": ["Desaparecieron", "Se multiplicaron", "Se hicieron de oro", "Se convirtieron en piedras"],
      "respuesta": "Se multiplicaron",
    },
    {
      "pregunta": "¿Qué hizo el vecino del labrador al enterarse del cazo mágico?",
      "opciones": ["Se lo regaló al labrador", "Lo acusó ante el juez", "Intentó robarlo", "Lo rompió"],
      "respuesta": "Lo acusó ante el juez",
    },
    {
      "pregunta": "¿Qué decidió hacer el juez al conocer la virtud del cazo?",
      "opciones": ["Devolvérselo al labrador", "Usarlo para el bien común", "Confiscarlo para quedárselo", "Destruirlo"],
      "respuesta": "Confiscarlo para quedárselo",
    },
    {
      "pregunta": "¿Qué sucedió cuando el padre del juez metió las monedas en el cazo?",
      "opciones": ["Las monedas desaparecieron", "Salieron más monedas", "El cazo dejó de funcionar", "Cayó en el cazo y comenzaron a aparecer padres idénticos"],
  ...
  void verificarRespuesta(BuildContext context) {
    if (respuestaSeleccionada == preguntas[indicePregunta]["respuesta"]) {
      ...
      _mostrarMensaje(context, "Incorrecto", "Respuesta incorrecta. La respuesta correcta era: '${preguntas[indicePregunta]["respuesta"]}'");
    }
